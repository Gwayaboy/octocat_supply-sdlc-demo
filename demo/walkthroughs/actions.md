...
- **Features:** GitHub Actions, Required workflows, Rulesets
...
- **Features:** GitHub Actions, Reusable workflows
...
- **Features:** GitHub Actions, Artifact Attestations
...
**Video**: [Watch Demo](https://microsofteur.sharepoint.com/:v:/s/octodemo/IQBOc9ehUXQjRrpfIz8AqbfLAdVkrsOxfO2nDx93OPcjWqY?e=kXa4JV&nav=%7B%22playbackOptions%22%3A%7B%22startTimeInSeconds%22%3A882%7D%7D)
...
- **Features:** GitHub Packages, Virtual Registry, GitHub Advanced Security
...
- **Features:** GitHub Actions, Virtual Registry
