...
The Copilot Spaces demo revolves around the Compliance Docs Copilot Space (name prefixed with `OD OctoCAT Supply Compliance Docs`), backed by the `od-octocat-supply-compliance-docs` repository — both provisioned specifically for your demo environment:

- 📁 **Compliance Docs Repository:** https://github.com/msft-common-demos/od-octocat-supply-compliance-docs
- 🤖 **Copilot Space:** https://github.com/copilot/spaces/msft-common-demos/11
...
- **Features:** Copilot Spaces

1. Navigate to your Compliance Docs Copilot Space using the link from the intro above (or navigate to `/copilot/spaces` in the Organization Tab and look for the space prefixed with `OD OctoCAT Supply Compliance Docs`).
...
- **Features:** Copilot Spaces, GitHub Issues

1. Navigate to `/copilot/` (Note: not `/copilot/spaces`).
2. Attach both your Compliance Docs Copilot Space (linked in the intro above) and your demo repository as additional context.
...
- **Features:** Copilot Spaces MCP tools, GitHub Remote MCP Server
...
> [!NOTE]
> In the prompts below, replace `OD OctoCAT Supply Compliance Docs` with the full name of your Compliance Docs Copilot Space (visible in the URL shown in the intro above).
