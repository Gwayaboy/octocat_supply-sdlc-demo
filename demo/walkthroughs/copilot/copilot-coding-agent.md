...
- **Features:** Copilot custom prompts, Copilot Chat Plan mode, Copilot in VSCode
...
- **Features:** Copilot custom prompts, Copilot Coding Agent, GitHub Remote MCP Server, Third-party coding agents (Claude / Codex)
...
- **Features:** Copilot custom prompts (prompt refinement), Copilot Vision
...
- **Features:** Copilot Coding Agent, GitHub Remote MCP Server, Copilot custom prompts
...
- **Features:** Copilot Coding Agent, GitHub Actions, GitHub Models, GitHub MCP Server
...
- **CodeQL Alerts:** You have to generate autofixes before you can assign them to CCA. See [Assign CodeQL Alerts to Coding Agents](../ghas/code-security.md#assign-codeql-alerts-to-coding-agents-copilot-) below.
  - `Database query built from user-controlled sources`
  - `Workflow does not contain permissions`

### Demo: Opinionated Mission Control Walkthrough

- **Features:** Copilot Coding Agent, Mission Control


**Video**: [Watch Demo](https://microsofteur.sharepoint.com/:v:/s/octodemo/IQDX59KyXVNjQItdlYgMilXeAT_-_RcrveJPf5X5ZF_NE1E?e=5xEh3d&nav=%7B%22playbackOptions%22%3A%7B%22startTimeInSeconds%22%3A776%7D%7D)
