...
applyTo: "api/src/**/*.ts, api/src/**/*.py, api/app/**/*.php, api/routes/**/*.php, api/package.json, api/pyproject.toml, api/composer.json, database/migrations/**, database/seed/**, api/api-swagger.json"
---
# API Review Guidance
